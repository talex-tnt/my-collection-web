...
import { useRawgSettings } from '../utils/hooks';

export default function SettingsRawg() {
  const [rawgSettings, setRawgSettings, { isLoading, isUpdating, getError }] =
    useRawgSettings();
              ...
              <div className="form-control">
                <label className="label cursor-pointer">
                  <input
                    ...
                    checked={rawgSettings?.enableSuggestions ?? true}
                    disabled={isUpdating}
