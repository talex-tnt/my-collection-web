...
function CollectorWishlistsPage() {
  ...
  const tab = location.pathname.includes('/wishlists/wishlists') || /\/wishlists\/wishlists\/.+/.test(location.pathname)
    ? 'wishlists'
    : 'spare';
  ...
  return (
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body space-y-4 px-2 sm:px-4">
        ...
        <Routes>
          <Route path="/spare" element={<CollectorFilterableWishes userId={userId} />} />
